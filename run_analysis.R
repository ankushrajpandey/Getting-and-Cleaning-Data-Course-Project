...
## Data download and unzip from the URL
...
##Redaing the Datasets finished with the variables.
...
# Created a vector of only mean and std, use the vector to subset.
...
# Created vector of "Clean" feature names by getting rid of "()" apply to the dataSet to rename labels.

CleanFeatureNames <- sapply(features[, 2], function(x) {gsub("[()]", "",x)})
names(dataSet) <- CleanFeatureNames[MeanStdOnly]

#Combined test and train of subject data and activity data.
...
#Grouped the activity column of dataSet, re-name lable of levels with activity_levels, and apply it to dataSet.
